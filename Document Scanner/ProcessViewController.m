...
-(void)initializeFooterView{
    ...
    [_editBtn setTitle:@"Function" forState:UIControlStateNormal];
...
-(void)deleteButtonClicked{
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Simple Scan"
                                                    message:@"Вы действительно хотите удалить текущие изменения?"
                                                   delegate:self
...
{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Simple Scan"
                                                    message:@"Изображение сохранено успешно!"
                                                   delegate:self
...
-(void)filterChangeButtonClicked{
    ...
    UIActionSheet* actionSheet = [[UIActionSheet alloc] initWithTitle:@"Выберите цветовую гамму" delegate:self cancelButtonTitle:@"Назад" destructiveButtonTitle:nil otherButtonTitles:@"Цветной",@"Серый",@"Черно Белый", nil];
